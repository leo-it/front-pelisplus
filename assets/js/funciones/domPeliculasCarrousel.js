        ...
        let htmlPeli2 = `  <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          <img src="https://hd-report.com/wp-content/uploads/2019/07/google-play-4k-uhd-grid-2019-1280px.jpg" class="d-block w-100 " alt="...">
                        ...
                        <div class="carousel-item">
                          <img src="https://hd-report.com/wp-content/uploads/2019/04/4k-blu-ray-may-2019-720px.jpg" class="d-block w-100" alt="...">
                          <div class="carousel-caption d-none d-md-block">
                            <h5></h5>
                            <p></p>
                           <!-- <button class="btn btn-primary " data-bs-target="#signinModal" data-bs-toggle="modal">Ingresa</button>-->
